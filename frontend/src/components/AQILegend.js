...
const AQILegend = () => {
  const levels = [
    ...
    { range: '101-150', level: 'Unhealthy for Sensitive', color: '#ff7e00', description: 'Children, elderly, and people with heart/lung conditions should limit outdoor activities' },
