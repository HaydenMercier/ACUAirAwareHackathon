...
const AQILegend = () => {
  const levels = [
    ...
    { range: '101-150', level: 'Unhealthy for Sensitive People', color: '#ff7e00', description: 'Children, elderly, and people with heart/lung conditions should limit outdoor activities' },
